...
$profilePicUrl = $s->studPic ? "https://assm-student-images.s3.amazonaws.com/user-images/{$s->studPic}" : "https://assm-student-images.s3.amazonaws.com/user-images/profile.png"; 
